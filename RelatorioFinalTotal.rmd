...
perfil.243.df.areas.de.atuacao$area[grepl("Florestais",perfil.243.df.areas.de.atuacao$area)] <- "Recursos Florestais"
...
### Grafico de barras; periodicos por ano; Biologia 242
```{r}
...
### Grafico de barras; periodicos por ano; Biologia 243
```{r}
...
### Grafico de barras; periodicos por ano; Biologia 313
```{r}
...
foram ordenados pelo número total de publicações em periódicos entre 2010 e 2017, cuja mediana foi apresentada pela linha vermelha do gráfico acima, que sinaliza
26 publicações no período total. O gráfico indica que, dos 23 pesquisadores inclusos no Programa de Patologia Molecular, dois se destacaram com publicações que mais que triplicaram este valor - com um deles chegando a 88 e outro atingindo 233 publicações em periódicos. Outra característica notável no PPG é a grande pluralidade de áreas de pesquisa dos pesquisadores - apenas um deles tem uma única linha de trabalho.
...
O gráfico acima indica o índice de participação dos pesquisadores do PPG de Patologia Molecular em eventos
