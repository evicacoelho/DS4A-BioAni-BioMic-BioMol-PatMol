...
### Grafico de barras; periodicos por ano; Biologia Microbiana
```{r echo=FALSE}
...
perfil.242.df.areas.de.atuacao %>%
  ...
  ggplot(aes(publicacoes, orientacoes_concluidas, color = area)) +
  geom_jitter(shape = 2, size = .8) +
  ggtitle('COncentração de áreas por grande área') +
  labs(x='Publicações',y='Orientações concluídas') + facet_wrap(grande_area ~ ., ncol = 2)
```

 Lembrando que um pesquisador possui mais de uma grande area, o pesquisador se repete entre diferentes graficos
