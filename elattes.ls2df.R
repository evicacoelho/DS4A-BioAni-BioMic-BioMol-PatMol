...
#################################
#Arquivo Publication
#Entrar com dois parametros. 
#O primeiro e o arquivo list e o segundo o tipo de producao desejada
...
#################################
#Arquivo Advise de Orientacoes
#Entrar com dois parametros. 
#O promeiro e o arquivo list e o segundo o tipo de orientacao desejada
...
g.ls2ig <- function(grafo) {
  ...
  graph_attr(g, "name") <- "Rede de Colaboracao"
  return(g)
}

#################################
#Arquivo Researchers by area
#Transforma em um Data Frame booleano com variaveis como areas e observacoes como Pesquisadores
